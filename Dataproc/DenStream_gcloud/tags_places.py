...
def clustering(x):
    ...
    if (len(last_mod) == 0) & (len(data)<sampleSkip):
        ...
        for sampleNumber in range(len(buffer_data)):
            ...
            if not merged and len(oMicroCluster) != 0:
                ...
                if (backupClosestCluster.radius <= epsilon):
                    ...
                    if (closestMicroCluster.weight > beta * mu):
                        oMicroCluster.pop(oMicroCluster.index(closestMicroCluster))
            ...
            if not merged:
                ...
                for clusterTest in pMicroCluster:
            ...
            if currentTimestamp % tp == 0:
                ...
                for cluster in pMicroCluster:
                    ...
                    if cluster.weight < beta * mu:
                        pMicroCluster.pop(pMicroCluster.index(cluster))
                ...
                for cluster in oMicroCluster:
                    ...
                    if cluster.weight < xsi:
                        ...
                        oMicroCluster.pop(oMicroCluster.index(cluster))
